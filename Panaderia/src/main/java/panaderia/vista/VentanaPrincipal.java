...
public class VentanaPrincipal extends JFrame {
    ...
    private void initComponents() {
        ...
        JButton btnGuardar = new JButton("Guardar en CSV");
        ...
        if (tipo != null) {
            ...
            if (opcion == JOptionPane.OK_OPTION) {
                try {
                    ...
                    // Se guarda el inventario actualizado en el archivo CSV
                    controlador.guardarEnCSV("productos.csv");
    ...
    private void registrarVentaProducto(String nombreProducto, int cantidadVendida) {
        ...
        // Se guarda el nuevo estado del inventario en el archivo CSV
        controlador.guardarEnCSV("productos.csv");
        ...
        // Se escribe la línea de venta al final del archivo "reporteVentas.csv"
        try (FileWriter fw = new FileWriter("reporteVentas.csv", true)) {
            fw.write(lineaVenta);
        } catch (IOException e) {
    ...
    private void mostrarVentas() {
        ...
        // Se intenta abrir y leer el archivo CSV que contiene las ventas
        try (BufferedReader br = new BufferedReader(new FileReader("reporteVentas.csv"))) {
            String linea;
